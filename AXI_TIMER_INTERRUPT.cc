...
unsigned int* timer_ptr_2 = (unsigned int* )0x42800010;
...
void Timer_InterruptHandler(void)
{
        ...
        *(timer_ptr) = 0x054;
        *(timer_ptr_2) = 0x054;
        unsigned int timer_ptr_val = *(timer_ptr + 2);
        unsigned int timer_ptr_2_val = *(timer_ptr_2 + 2);
        cout<<"timer_ptr_val is"<<timer_ptr_val<<endl;
        cout<<"timer_ptr_2_val is"<<timer_ptr_2_val<<endl;
        *(timer_ptr) = 0x154;
        *(timer_ptr_2) = 0x154;
        *(timer_ptr) = 0x0d4;
        *(timer_ptr_2) = 0x0d4;
